...
本文档提供了与本项目相关信息的各种文档和链接的概述。这里的所有内容都是根据本项目信息生成的，自动生成过程依靠 [Maven](http://maven.apache.org/) 。

### 概述

| 文档                                                         | 描述                                                         |
| :----------------------------------------------------------- | :----------------------------------------------------------- |
| [持续集成](https://mybatis.org/mybatis-3/zh/ci-management.html) | 持续集成是以一定的频率和固定的基础进行代码构建和测试的过程，这里列出了所有的持续集成过程。 |
| [项目依赖](https://mybatis.org/mybatis-3/zh/dependencies.html) | 这一文档列出了项目的依赖并提供了每个依赖的相关信息。         |
| [Dependency Information](https://mybatis.org/mybatis-3/zh/dependency-info.html) | This document describes how to to include this project as a dependency using various dependency management tools. |
| [Distribution Management](https://mybatis.org/mybatis-3/zh/distribution-management.html) | This document provides informations on the distribution management of this project. |
| [问题跟踪](https://mybatis.org/mybatis-3/zh/issue-management.html) | 这是本项目中的问题管理系统的链接。用户可以在这里进行问题(故障、特性、变更请求)的创建和查询。 |
| [项目授权](https://mybatis.org/mybatis-3/zh/licenses.html)   | 这是关于本项目授权的定义。                                   |
| [邮件列表](https://mybatis.org/mybatis-3/zh/mailing-lists.html) | 本文档提供了本项目的邮件列表的订阅和归档信息。               |
| [Plugin Management](https://mybatis.org/mybatis-3/zh/plugin-management.html) | This document lists the plugins that are defined through pluginManagement. |
| [Plugins](https://mybatis.org/mybatis-3/zh/plugins.html)     | This document lists the build plugins and the report plugins used by this project. |
| [源代码库](https://mybatis.org/mybatis-3/zh/scm.html)        | 这是一个在线代码库,它可以通过Web浏览器进行查看.              |
| [项目概要](https://mybatis.org/mybatis-3/zh/summary.html)    | 此文档列出了该项目其它的相关信息                             |
| [项目团队](https://mybatis.org/mybatis-3/zh/team.html)       | 本文档提供了本项目中成员的信息.他们是在本项目中以某种形式做出了贡献的个人. |