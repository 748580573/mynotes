> 摘自[《Java性能调优]》(https://time.geekbang.org/column/article/102619?utm_term=pc_interstitial_796)
...
当一个线程从 BLO CKED 状态进入到 RUNNABLE 状态时，我们称为一个线程的唤醒，此时线程将获取上次保存的上下文继续完成执行。
